...
Gem::Specification.new do |s|
  ...
  s.add_dependency 'avm-eac_asciidoctor_base0', '~> 0.26'
  ...
  s.add_dependency 'avm-eac_redmine_base0', '~> 0.23', '>= 0.23.1'
  ...
  s.add_dependency 'avm-eac_webapp_base0', '~> 0.21', '>= 0.21.1'
  s.add_dependency 'avm-eac_wordpress_base0', '~> 0.3', '>= 0.3.2'
  s.add_dependency 'avm-git', '~> 0.21'
  s.add_dependency 'avm-tools', '~> 0.163', '>= 0.163.4'
