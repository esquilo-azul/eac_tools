...
Gem::Specification.new do |s|
  ...
  s.add_dependency 'avm-eac_asciidoctor_base0', '~> 0.16'
  ...
  s.add_dependency 'avm-eac_rails_base0', '~> 0.10'
  s.add_dependency 'avm-eac_rails_base1', '~> 0.8', '>= 0.8.1'
  s.add_dependency 'avm-eac_redmine_base0', '~> 0.18', '>= 0.18.2'
  s.add_dependency 'avm-eac_redmine_plugin_base0', '~> 0.4'
  s.add_dependency 'avm-eac_ruby_base1', '~> 0.30'
