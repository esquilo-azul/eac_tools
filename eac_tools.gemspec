...
Gem::Specification.new do |s|
  ...
  s.files = Dir['{exe,lib,sub}/**/*', 'Gemfile', 'Gemfile.lock']
  s.bindir = 'exe'
  ...
  s.add_dependency 'avm-eac_rails_base1', '~> 0.11', '>= 0.11.2'
  s.add_dependency 'avm-eac_redmine_base0', '~> 0.24', '>= 0.24.1'
  ...
  s.add_dependency 'avm-eac_webapp_base0', '~> 0.21', '>= 0.21.4'
