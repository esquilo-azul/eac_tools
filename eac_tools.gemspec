...
Gem::Specification.new do |s|
  ...
  s.add_dependency 'avm-eac_generic_base0', '~> 0.6'
  s.add_dependency 'avm-eac_latex_base0', '~> 0.2', '>= 0.2.1'
  s.add_dependency 'avm-eac_php_base0', '~> 0.2'
  ...
  s.add_dependency 'avm-eac_ruby_base1', '~> 0.26'
  s.add_dependency 'avm-eac_webapp_base0', '~> 0.11'
  s.add_dependency 'avm-eac_wordpress_base0', '~> 0.2', '>= 0.2.1'
  s.add_dependency 'avm-tools', '~> 0.142', '>= 0.142.1'
