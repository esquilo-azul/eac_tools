...
Gem::Specification.new do |s|
  ...
  s.add_dependency 'avm', '~> 0.58'
  s.add_dependency 'avm-eac_asciidoctor_base0', '~> 0.12'
  ...
  s.add_dependency 'avm-eac_redmine_base0', '~> 0.17'
  ...
  s.add_dependency 'avm-tools', '~> 0.142', '>= 0.142.6'
